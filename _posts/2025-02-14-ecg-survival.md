...
No past work had systematically compared these modeling approaches, so that’s where this project started. We used three datasets: MIMIC-IV ECG (785k ECGs)[^mimic4], which had recently come out, Code-15 (233k), and the Boston Children’s Hospital dataset, “BCH” (182k).
